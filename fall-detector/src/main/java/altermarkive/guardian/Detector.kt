...
class Detector private constructor() : SensorEventListener {
    ...
    companion object {
        ...
        internal const val FALLING_WAIST_SV_TOT = 1.5
        internal const val IMPACT_WAIST_SV_TOT = 3.0
        internal const val IMPACT_WAIST_SV_D = 2.5
        internal const val IMPACT_WAIST_SV_MAX_MIN = 3.0
        internal const val IMPACT_WAIST_Z_2 = 3.0
